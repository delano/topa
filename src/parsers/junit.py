...
class JUnitParser(BaseParser):
    ...
    def _clean_xml(self, content: str) -> str:
        ...
        content = re.sub(r'&amp;(amp|lt|gt|quot|apos);', r'&\1;', content)  # Don't double-encode
    ...
    def _parse_testsuites(self, testsuites: List[ET.Element]) -> ParsedTestData:
        ...
        for testsuite in testsuites:
            ...
            file_results.append(ParsedFileResult(
                file_path=file_path,
        ...
        # Format time
        elapsed_time = self._parse_time_string(f"{total_time}s") if total_time > 0 else None
    ...
    def _extract_file_path_from_suite(self, testsuite: ET.Element, suite_name: str) -> str:
    ...
    def _parse_as_text(self, content: str, error_context: str) -> ParsedTestData:
        ...
        for line in lines:
            ...
            if 'test' in line.lower() or 'failure' in line.lower() or 'error' in line.lower():
        ...
        file_results = [ParsedFileResult(
            file_path="junit_parse_error.xml",
            test_results=test_results
        )]
